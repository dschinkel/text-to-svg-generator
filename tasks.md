...
## Task: FR.3.4 (Task 99) [IN PROGRESS]
### Goal: Add a "Filled Outer Outline" feature that includes both the outer outline and the filled text.
Acceptance:
- [ ] New SVG type "Filled Outer Outline" is generated by the backend.
- [ ] "Filled Outer Outline" preview is visible in the UI.
- [ ] A toggle "include filled outer outline" exists after the "Outer Outline" label.
- [ ] The toggle controls whether the "Filled Outer Outline" layer is included in the "Layered Preview".
- [ ] All tests pass.
