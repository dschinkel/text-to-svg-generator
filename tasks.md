...
## Task: FR.3.4 (Task 99) [COMPLETED]
### Goal: Add a "Filled Outer Outline" feature that includes both the outer outline and the filled text.
Acceptance:
- [COMPLETED] New SVG type "Filled Outer Outline" is generated by the backend.
- [COMPLETED] "Filled Outer Outline" preview is visible in the UI.
- [COMPLETED] A toggle "include filled outer outline" exists.
- [COMPLETED] The toggle controls whether the "Filled Outer Outline" layer is included in the "Layered Preview".
- [COMPLETED] All tests pass.

## Task: FR.3.4.1 (Task 100) [COMPLETED]
### Goal: Fix Filled Outer Outline gaps and move toggle placement.
Acceptance:
- [COMPLETED] Filled Outer Outline SVG is completely filled with no internal gaps.
